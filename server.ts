...
async function startServer() {
  ...
  // GET /api/woocommerce/orders - Fetch orders with pagination/filtering
  ...
  // PUT /api/woocommerce/orders/:id - Update order status
  app.put('/api/woocommerce/orders/:id', async (req, res) => {
    try {
      ...
      try {
        ...
        // If it's an HTML response, try fallback for non-pretty permalinks
  ...
  // GET /api/woocommerce/products - Fetch products with pagination/filtering
  ...
  // WebHook endpoint for WooCommerce order updates
